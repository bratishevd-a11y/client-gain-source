...
const faq = [
  { q: "Какие каналы привлечения клиентов работают в Узбекистане?", a: "В Ташкенте и по всей стране хорошо работают Instagram, Telegram-каналы и Telegram Ads, поисковая реклама Google и Яндекс, а также локальные маркетплейсы и CRM-рассылки. Под каждый бизнес собираем микс из 2–4 каналов, чтобы снижать стоимость заявки." },
  { q: "Сколько стоит лидогенерация в Узбекистане?", a: "Стоимость зависит от ниши, каналов и объёма работ. Стартовые пакеты — от 5 000 000 сум в месяц. После короткого брифа и аудита даём точную смету и прогноз по количеству заявок." },
  { q: "Как быстро появятся первые заявки?", a: "Первые лиды получаем в среднем через 3–7 дней после запуска. За это время создаём посадочные страницы на русском и узбекском языках, готовим креативы и настраиваем сквозную аналитику." },
  { q: "Работаете ли вы с узбекским и русским языком?", a: "Да. Мы готовим креативы, тексты и посадочные страницы на обоих языках — это важно, потому что аудитория в Узбекистане использует оба языка, особенно в Ташкенте." },
  { q: "Как оплачивать услуги из Узбекистана?", a: "Принимаем оплату банковским переводом для юридических лиц, а также через Click, Payme, Uzum Pay и карты Humo/Uzcard. Заключаем официальный договор с фиксацией KPI." },
  { q: "С какими нишами вы работаете в Узбекистане?", a: "Наш основной фокус — недвижимость, строительство, образование, медицина, HoReCa, розничная торговля, логистика и B2B-услуги. Для каждой ниши знаем специфику спроса и каналы коммуникации." },
  { q: "Можно ли встретиться в Ташкенте?", a: "Конечно. Мы находимся в Ташкенте и проводим личные встречи, презентации и аудиты. Также работаем онлайн с компаниями из Самарканда, Бухары, Ферганы и других городов." },
];
