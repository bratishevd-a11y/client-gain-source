...
const faq = [
  ...
  { q: "Сколько стоит лидогенерация в Узбекистане?", a: "Стоимость рассчитывается индивидуально под запрос: зависит от ниши, каналов, объёма работ и целевого количества заявок. После короткого брифа и аудита вышлем точную смету и прогноз по результатам." },
  ...
  { q: "С какими нишами и направлениями бизнеса вы работаете в Узбекистане?", a: "Работаем практически со всеми направлениями: недвижимость и строительство, образование и курсы, медицина и клиники, салоны красоты и HoReCa, розничная торговля и e-commerce, логистика и доставка, производство, финансовые и юридические услуги, IT и B2B-услуги, автобизнес, туры и путешествия. Для каждой ниши знаем специфику спроса и каналы коммуникации." },
];
